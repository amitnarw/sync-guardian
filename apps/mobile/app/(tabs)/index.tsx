...
const CHILD_AVATAR =
  "https://lh3.googleusercontent.com/aida-public/AB6AXuCurR4XH40Z01u0tqCA7rmHjrvlhqSTCSbg__UGwkervZcTGQyoia3SYT_bqDvFo49SulW7S1IffaIa8F0yhbcuRDx79xMcdGTBwxwr4A_BTWHNdepu6KOnFdAJNz7vpsJaZXRfMCxW0V9J-2xrtoa8g6hVCclDBAKJlodGhGpaohP935-CNMpZUqGjuL0bRdPgij3YL821CeYi4U5msMqjc0OYzryW2-lcVN9XbaIuDn48kljO1I6z6vJEjKaZAHP5Z1G-_C-_FPk";
...
export default function DashboardScreen() {
  ...
  const primaryDim = useThemeColor({}, "primaryDim");
        ...
        >
          ...
          <View style={{ paddingVertical: 32 }}>
            ...
            >
              ...
              <HearthBlob icon="verified_user" label="All is well" />
            </View>
            ...
            <ThemedText className="text-on-surface-variant text-base max-w-xs">
              Leo's digital environment is balanced. High focus levels detected
              during study hours.
            </ThemedText>
          </View>

          {/* Leo Status Card */}
          <SanctuaryCard variant="high" className="p-6 mb-4">
            <View className="items-center mb-4">
              <View className="relative">
                <View
                  className="w-32 h-32 rounded-full border-4 p-1"
                  style={{ borderColor: tertiaryContainer }}
                >
                  <Image
            ...
            <ThemedText
              className="text-center text-xl font-bold text-on-surface mb-1"
              style={{ fontFamily: "PlusJakartaSans-Bold" }}
            >
              Leo is Online
            </ThemedText>
            ...
            <View className="flex-row gap-3 justify-center mb-6">
              <View className="bg-surface-container-low dark:bg-surface-container px-5 py-3 rounded-full flex-row items-center gap-2">
                <IconSymbol
              ...
              <View className="bg-surface-container-low dark:bg-surface-container px-5 py-3 rounded-full flex-row items-center gap-2">
                <IconSymbol name="location_on" size={18} color={primary} />
                <ThemedText className="text-base font-medium text-on-surface">
                  Home
                </ThemedText>
              </View>
          ...
          {/* Bedtime CTA Card */}
          <View className="md:col-span-4 rounded-card mb-4 overflow-hidden shadow-lg shadow-primary/20">
            <LinearGradient
                ...
                <View key={i} className="flex-row items-center gap-4">
                  ...
                  <View className="flex-1 gap-1">
                    <View className="flex-row justify-between">
                      ...
                      <ThemedText className="text-sm text-on-surface-variant">
                        {app.time}
                      </ThemedText>
                    </View>
                    <View className="h-2 bg-surface-variant rounded-full overflow-hidden">
                      <View
                        className={`h-full ${app.barColor} rounded-full`}
          ...
          <View className="bg-surface-container-highest dark:bg-stone-800 rounded-card p-6 relative overflow-hidden mb-4">
            ...
            <View className="gap-3 relative z-10">
              <View className="bg-surface-container-highest dark:bg-stone-700 self-start px-3 py-1 rounded-full">
                <ThemedText className="text-[10px] font-bold uppercase tracking-tight text-on-surface-variant">
                  Daily Insights
                </ThemedText>
              </View>
              <ThemedText
              ...
              <ThemedText className="text-on-surface-variant text-sm">
                Educational content outpaced entertainment by 3:1 today. Great
                job guiding Leo's journey!
              </ThemedText>
